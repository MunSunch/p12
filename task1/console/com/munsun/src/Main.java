...
import com.munsun.Math;
import com.munsun.Fraction;

public class Main {
	public static void main(String... args) {
		var fraction = new Fraction(1,21,3);
		System.out.println("дробь: " + fraction.toMixedFraction());
		System.out.println("сокращенная дробь: " + fraction.shortFraction());
